...
const cleanData = fs.readFileSync('The Amity Affliction API Data (Songs) CLEAN.json', { encoding: 'utf-8'})
...
async function pushRequest(song) {
  try {
...
/*async function placeRequest(artist) {
  try {
